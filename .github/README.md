...
[`@aws-sdk/client-global-accelerator`](https://www.npmjs.com/package/@aws-sdk/client-global-accelerator/v/3.192.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-global-accelerator@3.192.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-isGFkFMv19WBKWmpsmVhaPqWHxo0cpf+zaoULZ7+EdNN+S+0xBCDPzH77GqVFnph
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-global-accelerator": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-global-accelerator@3.192.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-global-accelerator@3.192.0/index.min.mjs": "sha384-isGFkFMv19WBKWmpsmVhaPqWHxo0cpf+zaoULZ7+EdNN+S+0xBCDPzH77GqVFnph"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-global-accelerator/blob/refs/tags/3.192.0/LICENSE
```
